...
if(session_id() == '') {
session_start();
$_SESSION['orderid'] = trim(filter_input(INPUT_POST, 'orderid'));
}
...
$sql = 'SELECT * FROM orders WHERE orderid = "'.$orderid.'" ORDER BY date DESC';
...
<div class="table-responsive">
                <table class="table table-bordered table-hover" style="overflow-x:auto; background-color:#f2f2f2;">
                    <thead>
                        <tr>
                            <td colspan="15" style="color:#000000;"><h3><b>Order #: </b><?php echo $orderid;?></h3></td>
                        </tr>
                    </thead>
